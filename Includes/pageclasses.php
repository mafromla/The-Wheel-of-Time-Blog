<?php
/**
 * Page class based on a typical PHP/MySQL classes approach.
 * This class provides the layout structure for your website:
 *   - <html> / <head> tags
 *   - A dynamic <title>
 *   - The <body> with header, sidebar, main content, and footer
 * Simply set the public properties from your page (e.g. index.php)
 * and call $page->Display().
 */
class Page
{
    // --[ Public Properties ]-------------------------------------------------//
