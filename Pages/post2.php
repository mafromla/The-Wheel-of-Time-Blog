...
$page->title = "Why The Wheel Weaves As It Wills - The Wheel of Time Blog";
$page->cssScripts = "
...
$page->content = "
    <main class='content post-page'>
      <div class='text-post'>
        ...
        <h2>Why The Wheel Weaves As It Wills</h2>
        <p>
          The Pattern is more than a backdrop—it is the living, breathing force that interconnects every life, choice, and fate in the world of The Wheel of Time. In this post, we explore how seemingly random events are woven together by the timeless tapestry of destiny. From the rise and fall of empires to the quiet moments of personal triumph, every thread contributes to the grand design.
        </p>
