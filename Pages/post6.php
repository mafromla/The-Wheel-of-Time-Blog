...
$page->title = "The Power of Saidin and Saidar - The Wheel of Time Blog";
$page->cssScripts = "
...
$page->content = "
    <main class='content post-page'>
      <div class='text-post'>
        ...
        <h2>The Power of Saidin and Saidar</h2>
        <p>
          At the heart of the magic in The Wheel of Time lies the One Power, split into the male force of Saidin and the female force of Saidar. This post explores the distinct qualities and the complementary nature of these two halves. We discuss the unique challenges each side faces and what their interplay reveals about unity, balance, and the eternal duality at the series’ core.
        </p>
