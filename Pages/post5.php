...
$page->title = "Exploring the Dark One's Influence - The Wheel of Time Blog";
$page->cssScripts = "
...
$page->content = "
    <main class='content post-page'>
      <div class='text-post'>
        ...
        <h2>Exploring the Dark One's Influence</h2>
        <p>
          The Dark One’s presence is a constant, corrosive undercurrent in the world of The Wheel of Time. This post delves into how the Dark One’s touch manifests—from the corruption of the One Power to the internal struggles of those who dare get too close. We analyze how this sinister influence shapes destinies and sets the stage for the ultimate confrontation in the Last Battle.
        </p>
